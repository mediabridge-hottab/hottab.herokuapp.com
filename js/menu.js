...
$(document).ready(function() {
    ...
    $.ajax({
        url: 'http://api.hottab.pw/cashier/food-categories-list?token='+tokenKey.trim(),
    ...
    $.ajax({
        url: 'http://api.hottab.pw/admin/new-foods/category/'+idStart+'?hotel_id=10&lang=vi&token='+tokenKey.trim(),
        type:'get',
        success: function(data){
...
function directData(idDi){
    $.ajax({
        url: 'http://api.hottab.pw/admin/new-foods/category/'+idDi+'?hotel_id=10&lang=vi&token='+tokenKey.trim(),
        type:'get',
        success: function(data){
            //console.log(data['data']['foods']);
            $('#stars').empty();
